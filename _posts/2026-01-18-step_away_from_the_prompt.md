...
I have better, incremental and iterative tooling, but still, having an opinion and making up your mind as to where to go with the product takes time. As Chris Parsons wrote last summer: [Product work can not be parallelized](https://www.chrismdp.com/ai-swarms-failed-toyota-vs-ford-development/). Taste does not come cheap.
