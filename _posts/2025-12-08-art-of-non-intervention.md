...
Friction, tension, and conflict are part of change. Often these are symptoms of something else - the system is trying to tell you something. Techniques like co-creating a [diagram of effects](/2022/04/06/team-fluency-feedback-with-systems-thinking.html) or using [Moving Questions](https://www.movingquestions.com/the-5-questions-that-unlock-movement-when-nothing-else-works) can help to uncover the underlying dynamics and find interventions that do have a lasting impact. Or see that no intervention is needed.
