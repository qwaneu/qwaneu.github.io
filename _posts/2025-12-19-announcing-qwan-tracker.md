...
- Estimation. Tasks move one at a time, if they are too big, break them down or use another medium for the conversation.
- Enterprise management reporting (this is necessary sometimes, but not in the context of small teams of indie developers for instance, there are other tools for that).


Options
----

Things that we might build, but don't commit to

- API so that you can hook up your favorite language model to brainstorm with, or your coding agent to pick up tasks. 
- Renaming boards
